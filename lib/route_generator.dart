...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      // case '/LandingPage':
      //   return MaterialPageRoute(builder: (_) => LandingPageWidget(routeArgument: args as RouteArgument));
      case '/Tracking':
      ...
      case '/Mpesa':
        return MaterialPageRoute(builder: (_) => OrderSuccessWidget(routeArgument: RouteArgument(param: 'M-Pesa')));
      case '/PayOnPickup':
