...
class Order {
  ...
  Order.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      derivery_information = jsonMap['derivery_information'].toString();
  ...
  Map toMap() {
    ...
    map["derivery_information"] = derivery_information;
    map["user_id"] = user?.id;
