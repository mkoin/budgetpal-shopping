...
class CategoriesCarouselItemWidget extends StatelessWidget {
  ...
  CategoriesCarouselItemWidget({Key key, this.marginLeft, this.category, this.categories}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Category', arguments: RouteArgument(id: category.id, param: this.categories));
      },
      child: Column(
